...
In addition to having plugins for importing rich documents <<indexing-with-tika.adoc#indexing-with-tika,Indexing with Solr Cell and Apache Tika>>, Solr natively supports indexing structured documents in XML, CSV, and JSON.
