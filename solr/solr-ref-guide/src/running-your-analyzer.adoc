...
Luckily, there is a very handy page in the Solr <<solr-admin-ui.adoc#solr-admin-ui,admin interface>> that lets you do just that. You can invoke the analyzer for any text field, provide sample input, and display the resulting token stream.
