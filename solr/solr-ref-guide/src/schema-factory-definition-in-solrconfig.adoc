...
Solr's <<schema-api.adoc#schema-api,Schema API>> enables remote clients to access <<solr-schema.adoc#solr-schema,schema>> information, and make schema modifications, through a REST interface.
