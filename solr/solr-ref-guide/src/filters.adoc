...
Like <<tokenizers.adoc#tokenizers,tokenizers>>, filters consume input and produce a stream of tokens.
...
These stemmers are described in <<language-analysis.adoc#language-analysis,Language Analysis>>.
