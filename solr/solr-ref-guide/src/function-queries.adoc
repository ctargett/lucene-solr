...
Function queries are supported by the <<dismax-query-parser.adoc#dismax-query-parser,DisMax>>, <<edismax-query-parser.adoc#edismax-query-parser,Extended DisMax>>, and <<standard-query-parser.adoc#standard-query-parser,standard>> query parsers.
