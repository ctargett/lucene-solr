...
****
<<solr-admin-ui.adoc#solr-admin-ui,*Using the Solr Admin UI*>>: Solr's Web-based interface for administering Solr.
****
...
****
<<solr-control-script-reference.adoc#solr-control-script-reference,*Solr Control Script Reference*>>: The options available to the `bin/solr` or `bin\solr.cmd` scripts.
****
