...
Using the <<dismax-query-parser.adoc#dismax-query-parser,DisMax>> or <<edismax-query-parser.adoc#edismax-query-parser,Extended DisMax>>, you can combine spatial search with the boost function to boost the nearest results:
