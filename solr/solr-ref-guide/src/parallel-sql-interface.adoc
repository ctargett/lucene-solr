...
Because these functions never require data to be shuffled, the aggregations are pushed down into the search engine and are generated by the <<stats-component.adoc#stats-component,Stats component>>.
