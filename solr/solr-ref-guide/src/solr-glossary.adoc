...
[[schema]]<<solr-schema.adoc#solr-schema,Solr Schema (managed-schema or schema.xml)>>::
...
[[solrconfig]]<<configuring-solrconfig-xml.adoc#configuring-solrconfig-xml,SolrConfig (solrconfig.xml)>>::
