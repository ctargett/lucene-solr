...
*<<deployment-guide.adoc#deployment-guide,Deployment Guide>>*

This section includes information about installing Solr, taking it to production and how to run it in HDFS or AWS.

*<<solr-upgrade-notes.adoc#solr-upgrade-notes,Solr Upgrade Notes>>*: Notes for upgrading between minor versions and migrating to the next major version.
****
...
*<<schema-and-indexing.adoc#schema-and-indexing,Schema and Indexing Guide>>*
