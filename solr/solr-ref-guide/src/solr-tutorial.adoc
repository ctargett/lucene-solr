...
We have only scratched the surface of the search options available in Solr. For more Solr search options, see the section on <<query-guide.adoc#query-guide,Query Guide>>.
