...
****
<<configuration-apis.adoc#configuration-apis,*Configuration APIs*>>: Configuration APIs available.
...
****
<<scaling-solr.adoc#scaling-solr,*Scaling Solr*>>: Cluster configuration options.
