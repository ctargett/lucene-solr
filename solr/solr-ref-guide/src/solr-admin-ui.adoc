...
The first set of links are for system-level information and configuration and provide access to <<configuring-logging.adoc#logging-screen,Logging Screen>>, <<collections-core-admin.adoc#collections-core-admin,Collection/Core Administration>>, and <<jvm-settings.adoc#java-properties-screen,Java Properties Screen>>, among other things.
...
Clicking on a collection or core name shows secondary menus of information for the specified collection or core, such as a <<schema-browser-screen.adoc#schema-browser-screen,Schema Browser>>, <<configuration-files.adoc#files-screen,Files Screen>>, <<plugins-stats-screen.adoc#plugins-stats-screen,Plugins & Statistics>>, and an ability to perform <<query-screen.adoc#query-screen,Queries>> on indexed data.
...
| <<collections-core-admin.adoc#collections-core-admin,Collections / Core Admin>>: Collection or Core management tools.
...
[cols="1,1",frame=none,grid=none,stripes=none]
|===
| <<running-your-analyzer.adoc#running-your-analyzer,Analysis Screen>>: Test and validation tool for field type analyzers.
...
| <<schema-browser-screen.adoc#schema-browser-screen,Schema Browser>>: Schema details through the Admin UI.
|===
...
[cols="1,1",frame=none,grid=none,stripes=none]
|===
| <<ping.adoc#ping,Ping>>: Ping a named core to determine whether it is active.
| <<plugins-stats-screen.adoc#plugins-stats-screen,Plugins/Stats Screen>>: Statistics for request handlers, search components, plugins, and other installed components.
...
| <<segments-info.adoc#segments-info,Segments Info>>: A visualization of the underlying Lucene index segments.
|===
// end::ui-core-tools[]
****
