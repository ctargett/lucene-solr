...
The following example uses the <<local-parameters-in-queries.adoc#local-parameters-in-queries,local-params>> syntax and <<edismax-query-parser.adoc#edismax-query-parser,the edismax parser>> to highlight fields in `hl.fl`:
