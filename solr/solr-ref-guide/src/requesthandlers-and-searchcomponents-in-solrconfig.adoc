...
|stats |`solr.StatsComponent` |Described in the section <<stats-component.adoc#stats-component,Stats Component>>.
...
|terms |`solr.TermsComponent` |Described in the section <<terms-component.adoc#terms-component,Terms Component>>.
...
* `QueryElevationComponent`, described in the section <<query-elevation-component.adoc#query-elevation-component,Query Elevation Component>>.
...
* `TermVectorComponent`, described in the section <<term-vector-component.adoc#term-vector-component,Term Vector Component>>.
