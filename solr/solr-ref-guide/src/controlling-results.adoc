...
| <<collapse-and-expand-results.adoc#collapse-and-expand-results,Collapse and Expand Results>>: Collapse documents on according to grouping parameters and provide a way for clients to expand the results for users.
| <<result-grouping.adoc#result-grouping,Result Grouping>>: Group results based on common field values.
...
| <<query-elevation-component.adoc#query-elevation-component,Query Elevation Component>>: How to force documents to the top of the results for certain queries.
